...
x = DOM(pre_processor=[_pre_process_keyword_attrs, _htmx_pre_processor])

example_dom = x.div(
    id='root', class_='bg-white dark:bg-slate-800 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl'
)
print(f'[ {"example_dom":^20}]', example_dom)


a1 = x.div(class_='nav-bar full-width responsive')(x.h1(f'Welcome 11111'), example_dom)
print('[✖]', a1)
